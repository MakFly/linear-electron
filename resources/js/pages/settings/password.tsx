...
export default function Password() {
    ...
    const breadcrumbs: BreadcrumbItem[] = [{ title: t('settings.password.breadcrumb'), href: '/settings/account/password' }];
    ...
    const updatePassword: FormEventHandler = (e) => {
        ...
        put(route('password.update'), {
            preserveScroll: true,
            onSuccess: () => {
                toast.success({ title: t('settings.password.toastUpdated') });
                reset();
            },
            onError: (errors) => {
                toast.error({ title: t('settings.password.toastFailed') });
                ...
                <div className="space-y-6">
                    ...
                    <form onSubmit={updatePassword} className="space-y-6">
                        ...
                        <div className="flex items-center gap-4">
                            <Button loading={processing} loadingText={t('common.saving')}>
